...
function configureButtons() {
	...
	$("#createCustomerInvoice").on("click", createProjectRowHandler("/api/create_customer_invoice"));

	$("#createScopePDFv2").on("click", createProjectRowHandler("/api/create_scope_pdf_v2"));

	$("#createPurchaseOrder").on("click", createProjectRowHandler("/api/create_purchase_order"));
    ...
    $("#imageCompression").on("click", createProjectRowHandler("/api/image_compression"));
